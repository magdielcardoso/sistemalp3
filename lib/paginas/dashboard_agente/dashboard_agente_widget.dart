...
import 'dashboard_agente_model.dart';
export 'dashboard_agente_model.dart';

class DashboardAgenteWidget extends StatefulWidget {
  const DashboardAgenteWidget({super.key});

  @override
  State<DashboardAgenteWidget> createState() => _DashboardAgenteWidgetState();
}

class _DashboardAgenteWidgetState extends State<DashboardAgenteWidget> {
  late DashboardAgenteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardAgenteModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.apiPercentMaisVendido =
          await PorcentagemProdutoMaisVendidoCall.call(
        agente: currentUserUid,
        produtoId: FFAppState().produtoMaisVendidoCodigo,
      );
      _model.apiUsuarios = await UsuariosTable().queryRows(
        queryFn: (q) => q.eq(
          'uid',
          currentUserUid,
        ),
      ...
      FFAppState().update(() {
        ...
        FFAppState().fotoPath = _model.apiUsuarios!.first.fotoPath!;
        FFAppState().cargoid = _model.apiUsuarios!.first.cargosId!;
      });
    });
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: FutureBuilder<List<UsuariosRow>>(
                                        future: FFAppState().queryCacheNome(
                                          requestFn: () =>
                                          ...
                                          children: [
                                            ...
                                            CircularPercentIndicator(
                                              percent: valueOrDefault<double>(
                                                PorcentagemProdutoMaisVendidoCall
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: FutureBuilder<
                                                      ...
                                                      builder:
                                                        ...
                                                        List<NotificacoesRow>
                                                            listViewNotificacoesRowList =
                                                            snapshot.data!;
                                                        if (listViewNotificacoesRowList
                                                            .isEmpty) {
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Lottie
                                                                            .asset(
                                                                          'assets/lottie_animations/Animation_-_1712700521751_(1).json',
                                                                          width:
                                                                              20.0,
                                                                          height:
                                                                              15.0,
                                                                        ...
                                                                        Text(
                                                                          valueOrDefault<
                                                                            ...
                                                                            dateTimeFormat(
                                                                              'MEd',
                                                                              listViewNotificacoesRow.createdAt,
                                                                        ...
                                                                        Text(
                                                                          valueOrDefault<
                                                                              String>(
                                                                            listViewNotificacoesRow.titulo,
                                                                            'Titulo',
                                                                          ),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                                                        ...
                                                                        Text(
                                                                          valueOrDefault<
                                                                              String>(
                                                                            listViewNotificacoesRow.descricao,
                                                                            'Descrição',
                                                                          ).maybeHandleOverflow(
                                                                            maxChars:
                                                                                100,
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Text(
                                                                          '${listViewComissoesRow.taxaDeComissao?.toString()}'
                                                                              .maybeHandleOverflow(
                                                                            maxChars:
                                                                                100,
                                                                            replacement:
                                                                            ...
                                                                            context.pushNamed(
                                                                              ...
                                                                              queryParameters: {
                                                                                'numeroProposta': serializeParam(
                                                                                  listViewComissoesRow.numeroProposta,
                                                                                  ParamType.int,
                                                                                ),
                                                                                'codigoProduto': serializeParam(
                                                                                  listViewComissoesRow.codigoProduto,
                                                                                  ParamType.int,
                                                                                ),
                                                                                'valorFinanciado': serializeParam(
                                                                                  listViewComissoesRow.valorFinanciado,
                                                                                  ParamType.double,
                                                                                ),
                                                                                ...
                                                                                'parcelas': serializeParam(
                                                                                  listViewComissoesRow.parcelas,
                                                                                  ParamType.int,
                                                                                ),
                                                                                'taxaJuros': serializeParam(
                                                                                  listViewComissoesRow.taxaJuros,
                                                                                  ParamType.double,
                                                                                ),
                                                                                'taxaComissao': serializeParam(
                                                                                  listViewComissoesRow.taxaDeComissao,
                                                                                  ParamType.double,
                                                                                ),
                                                                                ...
                                                                                'codigoConvenio': serializeParam(
                                                                                  listViewComissoesRow.codigoConvenio,
                                                                                  ParamType.int,
                                                                                ),
                                                                                'idComissao': serializeParam(
                                                                                  listViewComissoesRow.idComissao,
                                                                                  ParamType.int,
                                                                                ),
                                                                              }.withoutNulls,

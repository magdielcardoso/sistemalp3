...
import 'minhas_comissoes_model.dart';
export 'minhas_comissoes_model.dart';

class MinhasComissoesWidget extends StatefulWidget {
  const MinhasComissoesWidget({super.key});

  @override
  State<MinhasComissoesWidget> createState() => _MinhasComissoesWidgetState();
}

class _MinhasComissoesWidgetState extends State<MinhasComissoesWidget>
    with TickerProviderStateMixin {
  late MinhasComissoesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MinhasComissoesModel());
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              'Veja e gerencie todas as comissões',
                                              style:
                                                  ...
                                                  child: FutureBuilder<
                                                    ...
                                                    builder:
                                                      ...
                                                      List<ComissoesRow>
                                                          ...
                                                          snapshot.data!;
                                                      if (lvComissoesComissoesRowList
                                                          .isEmpty) {
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children:
                                                                            ...
                                                                            Text(
                                                                              'Valor Financ. Líquido: ${valueOrDefault<String>(
                                                                                formatNumber(
                                                                            ...
                                                                            Text(
                                                                              'Taxa de Comissão: ${valueOrDefault<String>(
                                                                                lvComissoesComissoesRow.taxaDeComissao?.toString(),
                                                                                'Sem dados',
                                                                              )}',
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    fontFamily: 'Satoshi',
                                                                            ...
                                                                            Text(
                                                                              'Produto: ${valueOrDefault<String>(
                                                                                lvComissoesComissoesRow.codigoProduto?.toString(),
                                                                                'Sem dados',
                                                                              )}',
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    fontFamily: 'Satoshi',
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children:
                                                                          ...
                                                                          Card(
                                                                            ...
                                                                            color: lvComissoesComissoesRow.status == 'Paga'
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Text(
                                                                                valueOrDefault<String>(
                                                                                  lvComissoesComissoesRow.status,
                                                                                  'Status',
                                                                                ),
                                                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                      fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,

...
import 'relatorio_admin_model.dart';
export 'relatorio_admin_model.dart';

class RelatorioAdminWidget extends StatefulWidget {
  const RelatorioAdminWidget({super.key});

  @override
  State<RelatorioAdminWidget> createState() => _RelatorioAdminWidgetState();
}

class _RelatorioAdminWidgetState extends State<RelatorioAdminWidget> {
  late RelatorioAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RelatorioAdminModel());

...
class SistemaLP3SupabaseUser extends BaseAuthUser {
  SistemaLP3SupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> sistemaLP3SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = SistemaLP3SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}

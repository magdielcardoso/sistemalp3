...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF082851);
  late Color secondary = const Color(0xFF00D596);
  late Color tertiary = const Color(0xFF92FFDF);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF92FFDF);
  late Color secondaryText = const Color(0xFFFFFFFF);
  late Color primaryBackground = const Color(0xFF171717);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF315E97);
  late Color accent2 = const Color(0xFF92FFDF);
  late Color accent3 = const Color(0xFF019267);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF1DCC7C);
  late Color warning = const Color(0xFFF3DC3C);
  late Color error = const Color(0xFFED554A);

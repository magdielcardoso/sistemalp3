...
class ComissoesGerentesTable extends SupabaseTable<ComissoesGerentesRow> {
  @override
  String get tableName => 'comissoes_gerentes';

  @override
  ComissoesGerentesRow createRow(Map<String, dynamic> data) =>
      ComissoesGerentesRow(data);
}

class ComissoesGerentesRow extends SupabaseDataRow {
  ComissoesGerentesRow(super.data);

  @override
  SupabaseTable get table => ComissoesGerentesTable();
  ...
  double? get valorComissaoAgente => getField<double>('valor_comissao_agente');
  set valorComissaoAgente(double? value) =>
      setField<double>('valor_comissao_agente', value);
  ...
  double? get taxaDeComissaoAgente =>
      getField<double>('taxa_de_comissao_agente');
  set taxaDeComissaoAgente(double? value) =>
      setField<double>('taxa_de_comissao_agente', value);
  ...
  double? get valorComissaoGerente =>
      getField<double>('valor_comissao_gerente');
  set valorComissaoGerente(double? value) =>
      setField<double>('valor_comissao_gerente', value);

  double? get taxaDeComissaoGerente =>
      getField<double>('taxa_de_comissao_gerente');
  set taxaDeComissaoGerente(double? value) =>
      setField<double>('taxa_de_comissao_gerente', value);

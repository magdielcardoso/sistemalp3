...
class _MeuPerfilWidgetState extends State<MeuPerfilWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiComissoesVitalicios =
          await DashboardGroup.comissoesVitaliciosCall.call(
        idAgente: currentUserUid,
      );
      _model.apiProducoesVitalicios =
          await DashboardGroup.producoesVitaliciosCall.call(
        idAgente: currentUserUid,
      );
    });
                                  ...
                                  children: [
                                    FutureBuilder<List<UsuariosRow>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<UsuariosRow>
                                            profileInfoUsuariosRowList =
                                            snapshot.data!;
                                        final profileInfoUsuariosRow =
                                            profileInfoUsuariosRowList
                                                    .isNotEmpty
                                                ? profileInfoUsuariosRowList
                                                    .first
                                                                ...
                                                                await showDialog<
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          ...
                                                                          content:
                                                                              const Text('Deseja alterar a sua foto de perfil?'),
                                                                          actions: [
                                                                            TextButton(
